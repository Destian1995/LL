...
def workshop(faction, db_conn):
    ...
    def generate_random_name(filename=None):
        ...
        head_subclasses = {
            'c': ["Корона", "Венец", "Диадема", "Тиара", "Диадема", "Венок", "Обруч"],
            'h': ["Шлем", "Наголовье", "Капюшон", "Каска", "Шишак", "Мисюрка", "Ерихонка"],
            's': ["Шляпа", "Колпак", "Тюрбан", "Берет", "Феска", "Треуголка", "Цилиндр"],
        }

        # === ПОДКЛАССЫ ДЛЯ НОГ (тип 2) ===
        legs_subclasses = {
            'b': ["Сапоги", "Ботинки", "Постаменты", "Башмаки", "Чоботы", "Полусапожки", "Ботфорты"],
            'g': ["Поножи", "Наколенники", "Онучи", "Обмотки", "Наголенники", "Щитки", "Набедры"],
            's': ["Сандалии", "Тапочки", "Лапти", "Шлёпанцы", "Мокасины", "Эспадрильи", "Вьетнамки"],
        }

        # === ПОДКЛАССЫ ДЛЯ ТУЛОВИЩА (тип 3) ===
        torso_subclasses = {
            'p': ["Броня", "Латы", "Кираса", "Панцирь", "Доспех", "Кольчуга", "Хауберк", "Бригантина"],
            'r': ["Мантия", "Плащ", "Ряса", "Пелерина", "Накидка", "Пончо", "Кейп", "Паллий"],
            'l': ["Жилет", "Камзол", "Дублет", "Рубаха", "Хауберк", "Китель", "Френч", "Мундир"],
        }

        # === ПОДКЛАССЫ ДЛЯ АКСЕССУАРОВ (тип 4) ===
        accessory_subclasses = {
            'r': ["Кольцо", "Перстень", "Печатка", "Обруч", "Браслет-кольцо", "Кафф", "Серьга-кольцо"],
            'a': ["Амулет", "Талисман", "Медальон", "Подвеска", "Ладанка", "Филактерия", "Оберег"],
            'b': ["Браслет", "Наручи", "Запястье", "Манжета", "Поручи", "Напульсник", "Ожерелье"],
            'e': ["Серьга", "Каффа", "Пусета", "Висячие", "Клипсы", "Конго", "Протяжки"],
        }
        ...
        artifact_type = 0
        prefixes = prefixes_by_type[0]  # fallback
