...
class ResultsGame:
    ...
    def calculate_military_rank(self):
        ...
        rank_tables = {
            'Вампиры': [
                ("Владыка ночи", 1000000),
                ("Вечный граф", 800000),
                ("Темный лорд", 680000),
                ("Князь тьмы", 565000),
                ("Старший вампир", 505000),
                ("Ночной страж", 448000),
                ("Теневой охотник", 368000),
                ("Призрачный убийца", 294000),
                ("Темный воитель", 240000),
                ("Ночной рейнджер", 200000),
                ("Младший вампир", 172000),
                ("Темный слуга", 140000),
                ("Младший слуга вампира", 120000),
                ("Ночная тень", 90000),
                ("Плутонический следопыт", 78000),
                ("Серебряный следопыт", 60000),
                ("Вестник смерти", 40000),
                ("Пепел прошлого", 20000),
                ("Укушенный", -float('inf')),
            ],
            'Люди': [
                ("Главнокомандующий", 1000000),
                ("Верховный маршал", 800000),
                ("Генерал-фельдмаршал", 680000),
                ("Генерал армии", 565000),
                ("Генерал-полковник", 505000),
                ("Генерал-лейтенант", 448000),
                ("Генерал-майор", 368000),
                ("Бригадный генерал", 294000),
                ("Коммандер", 240000),
                ("Полковник", 200000),
                ("Подполковник", 172000),
                ("Майор", 140000),
                ("Капитан-лейтенант", 120000),
                ("Капитан", 90000),
                ("Платиновый лейтенант", 78000),
                ("Серебряный лейтенант", 60000),
                ("Сержант", 40000),
                ("Прапорщик", 20000),
                ("Рядовой", -float('inf')),
            ],
            'Эльфы': [
                ("Верховный правитель", 1000000),
                ("Лесной повелитель", 800000),
                ("Вечный страж", 680000),
                ("Магистр природы", 565000),
                ("Лесной воевода", 505000),
                ("Хранитель лесов", 448000),
                ("Мастер стрелы", 368000),
                ("Лесной командир", 294000),
                ("Древесный защитник", 240000),
                ("Мастер лука", 200000),
                ("Ловкий стрелок", 172000),
                ("Юркий воин", 140000),
                ("Стремительный охотник", 120000),
                ("Зеленый страж", 90000),
                ("Природный следопыт", 78000),
                ("Ученик жрицы", 60000),
                ("Начинающий охотник", 40000),
                ("Молодой эльф", 20000),
                ("Младший ученик эльфа", -float('inf')),
            ],
            'Адепты': [
                ("Верховный Инквизитор", 1000000),
                ("Великий Охотник на Еретиков", 800000),
                ("Магистр Святого Огня", 680000),
                ("Гранд-Инквизитор", 565000),
                ("Судья Правой Руки", 505000),
                ("Главный Следователь", 448000),
                ("Огонь Вердикта", 368000),
                ("Страж Чистоты", 294000),
                ("Палач Ереси", 240000),
                ("Исполнитель Клятвы", 200000),
                ("Сержант Ордена", 172000),
                ("Офицер Инквизиции", 140000),
                ("Кандидат Света", 120000),
                ("Новичок Клятвы", 90000),
                ("Причастный Костра", 78000),
                ("Ученик Веры", 60000),
                ("Искренний", 40000),
                ("Слушающий Слово", 20000),
                ("Пепел Греха", -float('inf')),
            ],
            'Элины': [
                ("Повелитель Огня и Пустыни", 1000000),
                ("Око Бури", 800000),
                ("Хранитель Песков", 680000),
                ("Гнев Ветров", 565000),
                ("Тень Дракона", 505000),
                ("Жар Пустыни", 448000),
                ("Клинок Вечного Солнца", 368000),
                ("Степной Судья", 294000),
                ("Мастер Ярости", 240000),
                ("Искра Пламени", 200000),
                ("Бегущий по Пескам", 172000),
                ("Вестник Жара", 140000),
                ("Порождение Торнадо", 120000),
                ("Песчаный Странник", 90000),
                ("Пыль Гривы", 78000),
                ("Песчинка", 60000),
                ("Забытый Ветром", 40000),
                ("Проклятый Солнцем", 20000),
