...
class ResultsGame:
    ...
    def calculate_military_rank(self):
        ...
        rank_tables = {
            ...
            'Элины': [
                ("Повелитель Огня и Пустыни", 100000),         # Высшее звание — правитель и носитель силы дракона
                ("Око Бури", 80000),                    # Могущественный маг, способный управлять стихиями
                ("Хранитель Песков", 68000),            # Страж древних знаний и тайн пустыни
                ("Гнев Ветров", 56500),         # Воин с драконьим пламенем в крови
                ("Тень Дракона", 50500),                # Верховный воевода, скрывающийся в песках
                ("Жар Пустыни", 44800),                 # Командир армии Элинов
                ("Клинок Вечного Солнца", 36800),       # Личный защитник правителя
                ("Степной Судья", 29400),               # Справедливый и беспощадный лидер кланов
                ("Мастер Ярости", 24000),               # Носитель разрушительной магии
                ("Искра Пламени", 20000),               # Опыченный боевой маг
                ("Бегущий по Пескам", 17200),             # Ловкий и быстрый воин-разведчик
                ("Вестник Жара", 14000),               # Маг с начальным контролем над огнём
                ("Порождение Торнадо", 12000),                 # Молодой ученик стихий
                ("Песчаный Странник", 9000),            # Путешественник, начинающий свой путь
                ("Пыль Гривы", 7800),                   # Первые шаги в службе клану
                ("Песчинка", 6000),                     # Начальный уровень, новичок
                ("Забытый Ветром", 4000),               # Отказавшийся от пути, но ещё не изгнанный
                ("Проклятый Солнцем", 2000),            # Изгой, потерявший связь с племенем
                ("Пепел Пустыни", -float('inf')),       # Полностью отверженный
            ],
        }
