...
class HowToPlayScreen(Screen):
    ...
    def build_ui(self):
        ...
        how_to_text = (
            ...
            "[b]Парламент и дворцовые интриги[/b]\n"
            "В игре присутствует система парламента, где заседают влиятельные члены совета фракции. У каждого из них — свои "
            "политические взгляды, интересы и амбиции.\n\n"
            "[b]Разные типы членов парламента:[/b]\n"
            ...
            "[b]Что будет, если игнорировать парламент?[/b]\n"
            "Если вы не будете пытаться угодить членам парламента, возможны следующие сценарии:\n\n"
            ...
            "- [b]Переворот:[/b] если вы полностью проигнорируете политическую игру, члены парламента могут потребовать "
