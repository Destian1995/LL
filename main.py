...
RANK_TO_FILENAME = {
    "Главнокомандующий": "1.png",
    "Верховный маршал": "2.png",
    "Генерал-фельдмаршал": "3.png",
    "Генерал армии": "4.png",
    "Генерал-полковник": "5.png",
    "Генерал-лейтенант": "6.png",
    "Генерал-майор": "7.png",
    "Бригадный генерал": "8.png",
    "Коммандер": "9.png",
    "Полковник": "10.png",
    "Подполковник": "11.png",
    "Майор": "12.png",
    "Капитан-лейтенант": "13.png",
    "Капитан": "14.png",
    "Платиновый лейтенант": "15.png",
    "Серебряный лейтенант": "16.png",
    "Сержант": "17.png",
    "Прапорщик": "18.png",
    "Рядовой": "1.png",
    ...
    "Темный лорд": "3.png",
    "Князь тьмы": "4.png",
    "Старший вампир": "5.png",
    "Ночной страж": "6.png",
    "Теневой охотник": "7.png",
    "Призрачный убийца": "8.png",
    "Темный воитель": "9.png",
    "Ночной рейнджер": "10.png",
    "Младший вампир": "11.png",
    "Темный слуга": "12.png",
    "Младший слуга вампира": "13.png",
    "Ночная тень": "14.png",
    "Плутонический следопыт": "15.png",
    "Серебряный следопыт": "16.png",
    "Вестник смерти": "17.png",
    "Пепел прошлого": "18.png",
    "Укушенный": "1.png",

    "Верховный правитель": "1.png",
    "Лесной повелитель": "2.png",
    "Вечный страж": "3.png",
    "Магистр природы": "4.png",
    "Лесной воевода": "5.png",
    "Хранитель лесов": "6.png",
    "Мастер стрелы": "7.png",
    "Лесной командир": "8.png",
    "Древесный защитник": "9.png",
    "Мастер лука": "10.png",
    "Ловкий стрелок": "11.png",
    "Юркий воин": "12.png",
    "Стремительный охотник": "13.png",
    "Зеленый страж": "14.png",
    "Природный следопыт": "15.png",
    "Ученик жрицы": "16.png",
    "Начинающий охотник": "17.png",
    "Молодой эльф": "18.png",
    "Младший ученик эльфа": "1.png",

    "Верховный Инквизитор": "1.png",
    "Великий Охотник на Еретиков": "2.png",
    "Магистр Святого Огня": "3.png",
    "Гранд-Инквизитор": "4.png",
    "Судья Правой Руки": "5.png",
    "Главный Следователь": "6.png",
    "Огонь Вердикта": "7.png",
    "Страж Чистоты": "8.png",
    "Палач Ереси": "9.png",
    "Исполнитель Клятвы": "10.png",
    "Сержант Ордена": "11.png",
    "Офицер Инквизиции": "12.png",
    "Кандидат Света": "13.png",
    "Новичок Клятвы": "14.png",
    "Причастный Костра": "15.png",
    "Ученик Веры": "16.png",
    "Искренний": "17.png",
    "Слушающий Слово": "18.png",
    "Пепел Греха": "1.png",

    "Повелитель Огня и Пустыни": "1.png",
    "Око Бури": "2.png",
    "Хранитель Песков": "3.png",
    "Гнев Ветров": "4.png",
    "Тень Дракона": "5.png",
    "Жар Пустыни": "6.png",
    "Клинок Вечного Солнца": "7.png",
    "Степной Судья": "8.png",
    "Мастер Ярости": "9.png",
    "Искра Пламени": "10.png",
    "Бегущий по Пескам": "11.png",
    "Вестник Жара": "12.png",
    "Порождение Торнадо": "13.png",
    "Песчаный Странник": "14.png",
    "Пыль Гривы": "15.png",
    "Песчинка": "16.png",
    "Забытый Ветром": "17.png",
    "Проклятый Солнцем": "18.png",
    "Пепел Пустыни": "1.png",
}
    ...
    def draw_fortresses(self):
        ...
        with self.canvas:
            ...
            for row in fortresses_data:
                ...
                # Делим на две строки: сначала имя города, затем фракция
