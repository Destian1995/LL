...
class Lor(Screen):
    ...
    def build_ui(self):
        ...
        how_to_text = (
            ...
            "Пока вампиры косили людей как траву, эльфы строили своё царство под властью лесной владычицы Натали.\n"
            "Северо-восток Лэрдона и войны смертных их почти не тревожили.\n"
            "Их защитник, владыка Люци, поклялся хранить Натали и её народ от любых угроз.\n"
