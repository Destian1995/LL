...
class NaturalLanguageProcessor:
    ...
    def _init_intent_patterns(self):
        ...
        return {
            ...
            'info_request': [
                r'(сколько|как.*много|какое.*количество).*(ресурс|золот|кристалл|армия|войск)',
            ...
            'demand_resources': [
                r'(требую|нужно|надо|хочу).*((\d+).*(золот|кристалл|ресурс)|ресурс|материал)',
                r'(дай|предоставь|отдай).*((\d+).*золот|кристалл)',
