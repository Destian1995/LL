...
class SeasonManager:
    ...
    FACTION_EFFECTS = [
        # 0 = Зима
        {
            ...
            'Полукровки':  {'stat': 0.60,  'cost': 1.25},   # -40% атак/защита, +25% стоимости
        },
        # 1 = Весна
        {
            ...
            'Полукровки':  {'stat': 0.97,  'cost': 0.95},   # -3% атак/защита, -5% стоимости
        },
        # 2 = Лето
        {
            ...
            'Полукровки':  {'stat': 1.60,  'cost': 0.65},   # +60% атак/защита, -35% стоимости
        },
        # 3 = Осень
        {
            ...
            'Полукровки':  {'stat': 0.90,  'cost': 1.17},   # -10% атак/защита, +17% стоимости
        },
    ]
