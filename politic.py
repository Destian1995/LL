...
faction_names_build = {
    ...
    "halidon_buildings_city": "Полукровки"
}
...
alliance_phrases = {
    "Эльфы": "Мы Вас прикроем, от огня врагов!",
    "Люди": "Светлого неба!",
    "Адепты": "Вместе мы непобедимы!",
    "Полукровки": "Надеюсь войны не будет...",
    "Вампиры": "Пора выбить кому то зубы. Так. На всякий случай"
}
...
def show_declare_war_form(faction, conn):
    ...
    faction_phrases = {
        "Эльфы": "Вы нарываетесь на драку? Я к Вашим услугам!",
        "Люди": "Тебя давно по голове били? Сейчас исправим!",
        "Адепты": "Меня поражает Ваша самоуверенность...",
        "Полукровки": "Пустыня поглодит Вас..",
        "Вампиры": "Я сейчас кому-то в лицо плюну...кто бы это мог быть?"
    }
